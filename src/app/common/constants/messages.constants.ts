export const MESSAGES = {
    ...
    PAYMENT: {
      ...
      VALIDATION_FAILED: 'Payment verification failed',
      INITIATED: 'Payment session created. Redirecting to payment gateway.',
      SUCCESS: 'Payment completed successfully',
      FAILED: 'Payment failed or was cancelled',
      PROCESSING: 'Payment is being processed',
      IPN_OK: 'IPN received and processed',
      DUPLICATE_IPN: 'IPN already processed',
    ...
    CHAT: {
      ...
      CONVERSATION_DELETED: 'Conversation removed from your inbox',
      ACCESS_DENIED: 'You do not have access to this conversation',
